...
const GuessPreviousNumberGame = () => {
  ...
  function generateOptions(correctNumber) {
    const previousNumber = correctNumber - 1;
    const options = new Set();
    options.add(previousNumber);
  ...
  function handleOptionClick(selectedOption) {
    const previousNumber = questionNumber === 1 ? 0 : questionNumber - 1;
    if (selectedOption === previousNumber) {
    ...
    <ContentWrapper>
      <div className="LearnNumbers h-full p-10 flex flex-col justify-center items-center">
        ...
        <p className="text-2xl font-semibold mb-7 text-center w-full">
          ...
          بخواند و گزینه معادل عدد قبلی (یکی کمتر از عدد نشان داده شده ) را
          انتخاب کند.
        </p>
...
export default GuessPreviousNumberGame